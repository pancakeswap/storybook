import { useTheme } from "./_shims";
import noop from "lodash/noop";
import { MultiSelect as PrimereactSelect } from "primereact/multiselect";
import React, { useCallback, useEffect, useImperativeHandle, useMemo, useRef, useState } from "react";
import { styled } from "styled-components";
import { Box, Flex } from "./_shims";
import { Checkbox } from "./_shims";
import { Column } from "./_shims";
import { ArrowDropDownIcon, SearchIcon } from "./_shims";
import { EmptyMessage } from "./EmptyMessage";
import SearchBox, { BORDER_RADIUS } from "./SearchBox";
import type { IAdaptiveInputForwardProps } from "./SearchBox";
import type { IMultiSelectChangeEvent, IMultiSelectProps, IOptionType, ISelectItem } from "./types";
