...
import type { IOptionType, ISelectItem } from "./types";
import { Box, Flex } from "./_shims";
import { CrossIcon } from "./_shims";
...
const StyledBox = styled(Box)<{ isFocus: boolean }>`
  ...
  padding: 5px 8px;
  min-height: 42px;
  ${({ isFocus }) => isFocus && `box-shadow: 0px 0px 0px 4px #7645D933, 0px 0px 0px 1px #7645D9;` /* eslint-disable-line no-restricted-syntax -- brand primary, no theme variant */}
`;
