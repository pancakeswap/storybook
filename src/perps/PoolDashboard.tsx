...
export function PoolDashboard({
  ...
  const utilColor =
    clampedUtil > 80 ? 'var(--pcs-colors-failure)' : clampedUtil > 60 ? 'var(--pcs-colors-warning)' : 'var(--pcs-colors-primary)'
      ...
      <div className="p-card">
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div
              style={{
                ...
                height: 36,
                borderRadius: '50%',
                background: 'linear-gradient(135deg, var(--pcs-colors-primary) 0%, var(--pcs-colors-secondary) 100%)',
                display: 'flex',
                alignItems: 'center',
          ...
          <div style={{ textAlign: 'right' }}>
            ...
            <p className="p-value" style={{ color: 'var(--pcs-colors-primary)' }}>
              {alpPrice}
            </p>
          </div>
        </div>
        ...
        <div className="p-stat-grid p-stat-grid-2" style={{ marginBottom: 12 }}>
          <div className="p-card-alt">
            ...
            <p className="p-value" style={{ color: 'var(--pcs-colors-success)', marginTop: 4 }}>
              {apr}
            </p>
          ...
          <div className="p-progress-bar" style={{ marginTop: 8 }}>
            <div
              ...
              style={{
                ...
                background:
                  clampedUtil > 80
                    ? 'linear-gradient(90deg, var(--pcs-colors-warning), var(--pcs-colors-failure))'
                    : 'linear-gradient(90deg, var(--pcs-colors-primary), var(--pcs-colors-secondary))',
              }}
            />
          </div>
          <div
