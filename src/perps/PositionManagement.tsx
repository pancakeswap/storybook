                ...
                <tr key={pos.id}>
                  ...
                  <td>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                      ...
                      <Badge variant={pos.direction as 'long' | 'short'}>
                  ...
                  {/* Entry / Mark */}
                  <td>
                    <p className="p-value-sm" style={{ color: 'var(--p-text-muted)', fontSize: 12 }}>
                      {pos.entryPrice}
                    </p>
                    <p className="p-value-sm" style={{ color: 'var(--p-primary)' }}>
                      {pos.markPrice}
                    </p>
                  </td>
                  ...
                  {/* Liquidation */}
                  <td>
                    <p className="p-value-sm" style={{ color: 'var(--p-short)' }}>
