      ...
      <div className="p-card">
        ...
        >
          ...
          <div style={{ textAlign: 'right' }}>
            ...
            <p className="p-value" style={{ marginTop: 4, color: 'var(--pcs-colors-primary)' }}>
              ${alpPrice}
            </p>
          </div>
        </div>
        ...
        <div className="p-input-wrap" style={{ marginBottom: 10 }}>
          <span style={{ color: 'var(--pcs-colors-text-subtle)', fontSize: 14 }}>ALP</span>
          <input
        ...
        <div className="p-card-alt" style={{ marginBottom: 16 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <p className="p-value" style={{ color: 'var(--pcs-colors-success)' }}>
