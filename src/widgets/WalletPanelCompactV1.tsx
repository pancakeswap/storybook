...
const SpotWalletGlyph = styled.img.attrs({ src: walletIcon, alt: '', width: 40, height: 40 })`
  display: block;
`

const PerpsChartGlyph = styled.img.attrs({ src: perpsChartIcon, alt: '', width: 40, height: 40 })`
  display: block;
`
...
type RenderTokenIcon = NonNullable<WalletPanelCompactV1Props['renderTokenIcon']>
...
const SPOT_LEGACY_ACTIONS = (
  fn: WalletPanelCompactV1Props['onSpotAction'],
): ActionItem[] => [
...
const PERP_LEGACY_ACTIONS = (
  fn: WalletPanelCompactV1Props['onPerpAction'],
): ActionItem[] => [
  { key: 'transfer', label: 'Transfer', onClick: () => fn?.('transfer') },
